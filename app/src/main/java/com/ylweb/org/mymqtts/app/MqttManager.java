...
public class MqttManager {
    ...
    public boolean doConnect() {
        ...
        if (client != null) {
            try {
                ...
                Log.d("","Connected to " + client.getServerURI() + " with client ID " + client.getClientId());
                flag = true;
            } catch (Exception e) {
            }
        }
    ...
    public boolean publish(String topicName, int qos, byte[] payload) {
        ...
        if (client != null && client.isConnected()) {
            ...
            Log.d("","Publishing to topic \"" + topicName + "\" qos " + qos);
    ...
    public boolean subscribe(String topicName, int qos) {
        ...
        if (client != null && client.isConnected()) {
            ...
            Log.d("","Subscribing to topic \"" + topicName + "\" qos " + qos);
            try {
